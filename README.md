...
1. Fork the Project
2. Create your Feature Branch (`git checkout -b feature/square-bounces`)
3. Commit your Changes (`git commit -m 'Add some square-bounces'`)
4. Push to the Branch (`git push origin feature/square-bounces`)
